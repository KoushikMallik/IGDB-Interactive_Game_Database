...
public class Review extends javax.swing.JFrame {
    ...
    public void jTable1() {
        try {
            String sql = "SELECT UserName, GameTitle, Rating, ReviewPost FROM Review R \n"
                    + "INNER JOIN Game G on G.GameId = R.GameId\n"
    ...
    private void initComponents() {
        ...
        jPanel5.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 110, 1110, 230));
